...
class ISpectGeneratedLocalizationRu extends ISpectGeneratedLocalization {
  ...
  @override
  String get togglePerformanceTracking => 'Переключить отслеживание производительности';
  ...
  @override
  String get pasteTxtOrJsonHere => 'Скопируйте содержимое файла .txt или .json и вставьте его сюда';

  @override
  String get pickFiles => 'Выбрать файлы';

  @override
  String get selectTxtOrJsonFromDevice => 'Выберите файлы .txt или .json с вашего устройства';

  @override
  String get onlyTxtAndJsonSupported => 'Поддерживаются только файлы .txt и .json (макс. 10 МБ)';
  ...
  @override
  String get pasteYourTxtOrJsonFileContentHere => 'Вставьте содержимое .txt или .json файла здесь...';

  @override
  String get process => 'Обработать';

  @override
  String get confirmClearAllDailySessions => 'Вы уверены, что хотите очистить все ежедневные сессии?';
